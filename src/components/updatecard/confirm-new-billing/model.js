...
class ConfirmNewBillingModel extends Model {
  get url() {
  ...
  initialize() {
    console.log('ConfirmNewBillingModel initialize')
    console.log(this)
  ...
  parse(resp) {
    console.log('ConfirmNewBillingModel parse')
    // console.log(resp)
    if (!_.isEmpty(resp)) {
  ...
  getCardExpiry() {
    console.log('ConfirmNewBillingModel getCardExpiry')
  ...
  getCurrentBillingInfo() {
    console.log('ConfirmNewBillingModel getCurrentBillingInfo')
  ...
  updateCurrentBillingInfo() {
    console.log('ConfirmNewBillingModel updateCurrentBillingInfo')
...
export default ConfirmNewBillingModel
