...
class MembershipSignInModel extends ATVModel {
  get defaults() {
    return {
      stuff: true,
    }
  ...
  initialize() {
    console.log('MembershipSignInModel initialize')
  ...
  signIn(data) {
    console.log('MembershipSignInModel signIn')
    const {
      email,
      password,
    } = data
  ...
  parse(resp) {
    console.log('MembershipSignInModel parse')
    console.log(resp)
    // debugger
    return resp
    // const data = {}
...
export default MembershipSignInModel
