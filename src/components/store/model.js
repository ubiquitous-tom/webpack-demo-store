...
class StoreHomeModel extends ATVModel {
  get default() {
    return {
  ...
  initialize() {
    console.log('StoreHomeModel initialize')
    const params = {
  ...
  parse(resp) {
    console.log('StoreHomeModel parse')
    console.log(resp)
    // return resp
  }

  success(model, resp, options) {
    console.log('StoreHomeModel success')
  ...
  error(model, resp, options) {
    console.log('StoreHomeModel error')
    console.log(model, resp, options)
    // debugger
    let message = ''
